#
# Be sure to run `pod lib lint AFNetworking+LE.podspec' to ensure this is a
...
Pod::Spec.new do |s|
s.name             = 'AFNetworking+LE'
s.version          = '0.0.1'
s.summary          = 'AFNetworking+LE是个人私有库.'
...
s.homepage         = 'http://192.168.1.117:8099/r/AFNetworking+LE.git'
# s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
s.license          = { :type => 'MIT', :file => 'LICENSE' }
s.author           = { 'LE' => '551998132@qq.com' }
s.source           = { :git => 'http://192.168.1.117:8099/r/AFNetworking+LE.git', :tag => s.version.to_s }
