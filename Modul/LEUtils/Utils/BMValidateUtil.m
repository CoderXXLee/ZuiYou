...
#import "BMValidateUtil.h"
#import <NSString+Extension.h>

@implementation BMValidateUtil
...
+ (BOOL)isValidateContactNumber:(NSString *)mobileNum{
    ...
    if(([regextestmobile evaluateWithObject:mobileNum] == YES)
       ...
       || ([regextestPHS evaluateWithObject:mobileNum] == YES)){
        ...
        BOOL check = [self isMatchedByRegex:mobileNum];
        return check;
    }
}
...
+ (NSString *)getBankName:(NSString *)cardId {
    NSString *hintStr = @"未识别出银行卡";
    if (!LEStrNotEmpty(cardId)) return hintStr;
