...
s.version          = '0.0.1'
s.summary          = 'PageViewController是私有库.'
...
s.homepage         = 'http://192.168.1.117:8099/r/PageViewController.git'
# s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
s.license          = { :type => 'MIT', :file => 'LICENSE' }
s.author           = { 'LE' => '551998132@qq.com' }
s.source           = { :git => 'http://192.168.1.117:8099/r/PageViewController.git', :tag => s.version.to_s }
# s.social_media_url = 'https://twitter.com/<TWITTER_USERNAME>'

s.ios.deployment_target = '8.0'

s.source_files = '*.{h,m}', 'WMPageController/**/*.{h,m}'

#s.resource_bundles = {
#    'PageViewController' => ['image.bundle']
#}
