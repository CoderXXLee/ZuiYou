#
# Be sure to run `pod lib lint LETableView.podspec' to ensure this is a
...
s.homepage         = 'http://192.168.1.117:8099/r/LETableView.git'
# s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
s.license          = { :type => 'MIT', :file => 'LICENSE' }
s.author           = { 'LE' => '551998132@qq.com' }
s.source           = { :git => 'http://192.168.1.117:8099/r/LETableView.git', :tag => s.version.to_s }
